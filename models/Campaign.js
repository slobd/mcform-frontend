...
const campaignSchema = Schema(
    {
        ...
        title: {
            ...
            default: {
                icon: "",
                text: "Share your Photo with network and friends",
                font_family: "inherit",
                font_weight: 700,
                font_size: 30,
                line_height: 30,
        ...
        enable_edge: {type: Boolean, default: false},
        ...
        show_download_options: {type: Boolean, default: false},
        download_image: {
            type: textSchema,
            default: {
                icon: "",
        ...
        imprint_link: {type: String, default: "https://about.livedab.com/impressum/"},
        data_privacy_link: {type: String, default: "https://about.livedab.com/datenschutzbestimmungen/"},
    },
    {
        timestamps: true,
    }
