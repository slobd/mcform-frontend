    ...
    bcrypt.genSalt(saltRounds, (err, salt) => {
        bcrypt.hash(req.body.password, salt, async (err, hash) => {
            const campaign = new Campaign({
                ...
                password_protected: req.body.password_protected,
                password: hash,
                ...
                enable_edge: req.body.enable_edge,
                edge: req.body.edge,
                ...
                show_download_options: req.body.show_download_options,
...
const editCampaign = async (req, res) => {
    ...
    bcrypt.genSalt(saltRounds, (err, salt) => {
        bcrypt.hash(req.body.password, salt, async (err, hash) => {
            ...
            campaign.show_title = req.body.show_title;
            campaign.title = req.body.title;
            campaign.show_description = req.body.show_description;
            campaign.description = req.body.description;
            campaign.filters = req.body.filters;
            campaign.show_logo = req.body.show_logo;
            campaign.logo = req.body.logo;
            campaign.logo_setting = req.body.logo_setting;
            campaign.dark_mode = req.body.dark_mode;
            campaign.password_protected = req.body.password_protected;
            ...
            campaign.enable_edge = req.body.enable_edge;
            ...
            campaign.show_download_options = req.body.show_download_options;
            ...
            try {
                const dataToSave = await campaign.save();
                const _campaign = await Campaign.findOne({_id: req.body._id});
